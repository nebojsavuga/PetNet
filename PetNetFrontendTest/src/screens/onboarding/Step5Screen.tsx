        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.upperContent}>
                ...
                <View style={styles.dataSection}>
                    ...
                    <View style={styles.input}>
                        <Text style={[Typography.bodyExtraSmall, { color: '#F1EFF2' }]}>Sex</Text>
                        <TextInput placeholderTextColor={'#D8D5D9'} placeholder='Your sex' style={[Typography.bodySmall, styles.inputField]} />
                    </View>
                    <View style={styles.rowInputs}>
                        ...
                        <View style={[styles.input, { flex: 1 }]}>
                            ...
                            <TextInput placeholderTextColor={'#D8D5D9'}
                                ...
                                style={[Typography.bodySmall, styles.inputField]}
                            />
                        </View>
                    </View>
                </View>
            ...
            <View style={styles.connectionSection}>
                <Pressable style={styles.createNewAccountButton} onPress={() => navigation.navigate("Step6")}>
